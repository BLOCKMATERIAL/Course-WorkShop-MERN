  ...
  if (loading) {
    return (
      <div className="my-32 text-2xl text-center">
        У списку бажань не знайдено жодного товару
      </div>
    );
  }
  return (
            ...
            return (
              ...
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  {product.pQuantity > 0 ? (
                    <div className="text-green-500 my-1 md:my-0">В наявності</div>
                  ) : (
                    <div className="text-red-500 my-1 md:my-0">Нема наявності</div>
                  )}
  ...
  return (
    <Fragment>
      <section className="mx-4 mt-20 md:mx-12 md:mt-32 lg:mt-24">
        <div className="text-2xl mx-2 mb-6">Список бажань</div>
        {/* Product List */}
        <Product />
      </section>
    </Fragment>
