...
const Signup = (props) => {
  ...
  return (
    <Fragment>
      <div className="text-center text-2xl mb-6">Регистрація</div>
      <form className="space-y-4">
        {data.success ? alert(data.success, "green") : ""}
        <div className="flex flex-col">
          <label htmlFor="name">
            Ім'я<span className="text-sm text-gray-600 ml-1">*</span>
          </label>
          <input
            onChange={(e) =>
              setData({
        ...
        <div className="flex flex-col space-y-2 md:flex-row md:justify-between md:items-center">
          <div>
            ...
            <label htmlFor="rememberMe">
              Запамятати мене<span className="text-sm text-gray-600">*</span>
            </label>
          </div>
