    ...
    <Fragment>
      ...
      >
        ...
        >
          ...
          <span className="hover:text-gray-800">Головна</span>
        </div>
        ...
        >
          ...
          <span className="hover:text-gray-800">Категорії</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-gray-800">Продукт</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
        ...
        >
          ...
          <span className="hover:text-gray-800">Замовлення</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
