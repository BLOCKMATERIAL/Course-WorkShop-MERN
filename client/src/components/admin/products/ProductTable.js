    ...
    <Fragment>
      <div className="col-span-1 overflow-auto bg-white shadow-lg p-4">
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 border">Зоображення</th>
              <th className="px-4 py-2 border">Статус</th>
              <th className="px-4 py-2 border">Наявності</th>
              <th className="px-4 py-2 border">Категорія</th>
              <th className="px-4 py-2 border">Оффер</th>
              <th className="px-4 py-2 border">Стоворено</th>
        ...
        <div className="text-sm text-gray-600 mt-2">
          Сумарно {products && products.length} товар знайдено
        </div>
      </div>
    </Fragment>
  );
